...
## Retrieving Video Subtitles with `YouTube Summary with ChatGPT`
  ...
  - As a last resort, you can retrieve subtitles with the Chrome plugin [YouTube Summary with ChatGPT](https://chrome.google.com/webstore/detail/youtube-summary-with-chat/nmmicjeknamkfloonkhhcjmomieiodli/related)
